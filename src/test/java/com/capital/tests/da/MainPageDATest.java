...
@DisplayName("Check the login and registration buttons on the main page. (Danish)")
public class MainPageDATest extends Base {
    OldMainPage oldMainPage = new OldMainPage();
    HeaderPage headerPage = new HeaderPage();

    @ParameterizedTest(name = "{1}")
    @CsvFileSource(resources = "/LicenceDA.csv")
    @Order(1)
