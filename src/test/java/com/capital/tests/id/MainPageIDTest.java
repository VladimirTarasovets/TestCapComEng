...
@DisplayName("Check the login and registration buttons on the main page. (Bahasa Indonesia)")
public class MainPageIDTest extends Base {
    OldMainPage oldMainPage = new OldMainPage();
    HeaderPage headerPage = new HeaderPage();

    @ParameterizedTest(name = "{1}")
    @CsvFileSource(resources = "/LicenceID.csv")
    @Order(1)
